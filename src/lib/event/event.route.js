...
router.get("/participant/me", authenticate, controller.getEventsByParticipant);

router.get("/eventTypes", controller.getEventTypes);
router.get("/", controller.getAllEvents);

router.get("/:id", controller.getEventById);
router.get("/host/me", authenticate, controller.getEventsByHost);
...
router.post(
  "/supplier/remove",
  authenticate,
  controller.removeSupplierFromEvent
);
...
router.post(
  "/participant/remove",
  authenticate,
  controller.deleteParticipantByHost
);
...
router.post(
  "/event/invitationPicture/add",
  authenticate,
  controller.addInvitationPicture
);

router.post(
  "/invitationPicture/remove",
  authenticate,
  controller.removeInvitationPicture
);

router.put(
  "/event/invitationPicture",
  authenticate,
  controller.putInvitationPicture
);
